...
INSTDIR="OpenSource/PaleMoon"
INSTNAME='palemoon-*.en-US.linux-x86_64.tar.bz2'
## Installation post-processing:
INSTRENAME='palemoon/'"$PROGDIR"
INSTICON="$PROGDIR.png"

PRERUN="Pale Moon Firefox fork
...
function INSTFUNCTION {
    profDir="$HOME/.moonchild productions/pale moon"
    if [[ ! -d "$profDir" ]]; then
        msg "$FgYellow" "

PaleMoon profile directory not yet created. After running Pale Moon,

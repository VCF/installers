...
INSTDIR="GOG/$PROGDIR"
INSTNAME='setup_deadly_days_*.exe'
...
WINETARGET="GOG Games/Deadly Days"
...
PRERUN="
Refuses to even install - pop-up says
   This system does not meet the minimum requirements
... and then proceeds to install a nearly empty folder with just the
uninstall script
"

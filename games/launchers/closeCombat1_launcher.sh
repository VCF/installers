...
INSTNAME='setup_close_combat_2.*.exe'
...
WINETARGET="GOG Games/Close Combat"
...
PRERUN="
Wine Silver / Garbage
  https://appdb.winehq.org/objectManager.php?sClass=version&iId=6369&iTestingId=48571

Launcher notes that this isn't Win 95 or Win NT and refuses to run.
